...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTest
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "heartgoldkid@gmail.com", ZipCode = "WI" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("heartgoldkid@gmail.com", "Forms"), null);
